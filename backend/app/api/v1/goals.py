...
def create_goal(
    ...
    goal_type = (payload.goal_type or "GENERAL").upper().strip()
    # Architecture dedicated emergency fund type
    if goal_type in {"EMERGENCY", "EMERGENCY_FUND", "EFUND"}:
        goal_type = "EMERGENCY"
...
def contribute_to_goal(
    ...
    tx = accounting_service.post_goal_contribute(
        db,
        family_id=payload.family_id,
        member_id=member.id,
        wallet=wallet,
...
def withdraw_from_goal(
    ...
    tx = accounting_service.post_goal_withdraw(
        db,
        family_id=payload.family_id,
        member_id=member.id,
        wallet=wallet,
