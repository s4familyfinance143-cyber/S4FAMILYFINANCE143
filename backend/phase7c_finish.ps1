...
insp = inspect(engine)
required = ["families", "family_members", "member_permissions", "users", "accounts", "transactions", "transaction_lines"]
missing = [t for t in required if t not in insp.get_table_names()]
